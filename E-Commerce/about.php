...
<body>
    ...
    <section class="about">
        ...
        <div class="row">
            ...
            <div class="image">
                <img src="resources/images/about-img.svg" alt="">
            </div>
    ...
    <section class="reviews">
        ...
        <div class="swiper reviews-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide">
                    <img src="resouces/images/pic-4.png" alt="">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia tempore distinctio hic, iusto
                        adipisci a rerum nemo perspiciatis fugiat sapiente.</p>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                ...
                <div class="swiper-slide slide">
                    <img src="resouces/images/pic-5.png" alt="">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia tempore distinctio hic, iusto
                        adipisci a rerum nemo perspiciatis fugiat sapiente.</p>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                ...
                <div class="swiper-slide slide">
                    <img src="resouces/images/pic-6.png" alt="">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia tempore distinctio hic, iusto
                        adipisci a rerum nemo perspiciatis fugiat sapiente.</p>
                    <div class="stars">
                        <i class="fas fa-star"></i>
