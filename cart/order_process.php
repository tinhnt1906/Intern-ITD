...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-creditcardvalidator/1.2.0/jquery.creditCardValidator.js">
    </script>
    <style>
    .popover {
        width: 100%;
                    ...
                    <div class="row">
                        <div class="col-md-8" style="border-right:1px solid #ddd;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="card_holder_number" id="card_holder_number"
                                    class="form-control" placeholder="1234 5678 9012 3456" maxlength="20"
                                    onkeypress="" />
                            ...
                            <div align="center">
                                ...
                                <input type="button" name="button_action" id="button_action"
                                    class="btn btn-success btn-sm" onclick="stripePay(event)" value="Pay Now" />
                            </div>
                            <br />
                        </div>
                        <div class="col-md-4">
...
var stripe = Stripe(
    'pk_test_51MmC4ZL4VsvdryfRZKtARMXSMcjZmq0AM9JxMCg4JdolL16V45h3LfRjhy52qTg6z0wd2X5gdZLOZgvx5Pb7rI5V00qyV171gl');
